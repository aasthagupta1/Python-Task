A Django-based web application for managing an online library system. Admins can manage Authors, Books, and Borrow Records, with features like pagination and Excel export.
